...
new Act("Lena d’Água e Primeira Dama", "assets/artists/lenadagua.jpg", "A diva pop portuguesa que triunfou nos anos '80 está de regresso. Com as suas participações nas últimas edições do Festival RTP da Canção e na série original de Nuno Markl '1986', a autora do albúm revolucionário 'Perto de Ti' (tudo obras de arte a ver/ouvir) não mostra sinais de reforma. Desta vez aliado de um dos BFF's do Filipe Sambado, Lena e Primeira Dama, que na realidade é um moço (mas isso agora já não interessa nada), vão aliar forças e fazer o que só Deus sabe. Talvez tocar a música com os Ciclo Preparatório, isso era bom!", 3, "11", 19, 0),
new Act("Linda Martini", "assets/artists/lindamartini.jpg", "O nome é de um quadro italiano, quem diria! Provavelmente a única banda que só tem uma rapariga e não é a vocalista nem é a que fala mais. Lançaram albúm novo e estão em todo o lado e é mexido, é atribulado. Talvez não seja o seu tipo de balada, mas as letras ficam na cabeça.", 3, "11", 20, 0),
new Act("Luís Severo", "assets/artists/luissevero.jpg", "Com o melhor albúm português de 2017, este rapaz da MATERNIDADE finalmente vai concretizar o seu sonho de ir ao BONS SONS. Conhecido pela sua música sobre as torres do Técnico, tem como inspiração tudo o que é perto da Almirante Reis, a avenida dos alternos. De voz bonita, cabelo estranho e nome severo, só esperamos ansiosamente pelo concerto deste cão da morte.", 1, "11", 21, 0),
new Act("Moonshiners", "assets/artists/moonshiners.jpg", "Não confundir com o heavy metal dos Moonspell. Destes ninguém ouviu falar, ainda ;)", 1, "11", 23, 0),
new Act("Monday", "assets/artists/monday.jpg", "A irmã mais produtiva das Golden Slumber (a outra é da Vaarwell), aquela que tem dado de falar mais. A rapariga atua no domingo porque não à festival no dia seguinte. Ela canta, ela toca e ela é amiga do Samuel Úria. Queremos número miga!", 3, "11", 18, 0),
new Act("Dead Combo", "assets/artists/deadcombo.jpg", "Aquela banda com a música calma e a capa do albúm engraçado e uma pistola acho eu. Nem parecem portugueses mas são cá da terra. Talvez por estarem mortos, nem sei.", 2, "11", 22, 0),
];
